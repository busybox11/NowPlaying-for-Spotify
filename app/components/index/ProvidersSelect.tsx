...
import { LuMusic, LuArrowRight, LuRefreshCcw } from "react-icons/lu";
...
function ProviderBtn({ provider }: { provider: IProviderClient }) {
  ...
  return (
    ...
    >
      <div className="bg-black/5 ring-1 ring-white/20 border-1 border-black/50 rounded-full p-3">
            ...
            {playingState ? (
              <>
                <img
                  ...
                  className="inline-block size-3 mr-2"
                />
