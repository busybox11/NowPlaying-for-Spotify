    ...
    function loopForever () {
        setInterval(function() {
            ...
            function noInformations () {
                ...
                albumSong = "";
                title = "<?=defaultTitle;?>";
                albumPicture = "assets/images/no_song.png";
                lenghtSong = " ";
                lenghtSongFormatted = " ";
                progressSong = " ";
...
<body>
    ...
    <div id="playing-div">
        <div id="img-wrapper"><img src="assets/images/no_song.png" id="playing-img">
    ...
    <div id="background-image-div" style="background: url('assets/images/no_song.png'); background-size: cover;background-position: center center;"><div class="darken"></div></div>
