...
define('defaultTitle', 'Neniu muziko - Spotify Connect - Now Playing');
define('ad', 'Reklamo');

define('title_artistSong', "%title% de %artist%");

define('Error', 'Eraro');
define('IndexError404', 'Tiu retpaĝo ne ekzistas. Ĉu vi provus kodumi min?');

define('IndexGoBack', 'Reiri');

define('streamTitleSong', 'Neniu muziko nune ludantas');
